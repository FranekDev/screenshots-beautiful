...
{{--        <div class="w-full h-full flex pl-32 gap-5">--}}
        <div class="flex flex-col sm:flex-row gap-5 w-full h-full pl-4 md:pl-32">
{{--            <div class="w-full flex flex-col justify-start items-start gap-10 bg-dots bg-no-repeat bg-left-top pt-10 mt-8">--}}
            <div class="flex flex-col justify-start items-start gap-10 bg-dots bg-no-repeat bg-left-top pt-10 mt-8 w-full">
                <x-title class="">Create</x-title>

                <div class="flex w-full justify-center items-start gap-24 flex-col md:flex-row">
                    <div class="w-auto flex justify-between items-end">
                            ...
                            >
                                ...
                                >
                                    <img
                                        ...
                                        alt="Image"
                                        class="max-w-xl w-auto h-full max-h-[300px] rounded-xl shadow-xl transition-all object-contain"
                                        id="image-preview"
                                    >
                                </div>
                            </div>
                    ...
                    <div class="border-4 border-green-400 flex flex-col justify-center items-center h-fit md:w-auto w-fit">

                        <div class="flex flex-col w-auto h-full">
                            <div class="flex flex-col gap-3 w-fit items-start px-4 py-6">
...
{{--            <div class="flex justify-center mt-36 w-full sm:w-auto h-fit">--}}
